        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li className="flex space-x-4 mt-2">
              <a href="https://www.linkedin.com/company/foundrr/" aria-label="LinkedIn" className="bg-white/10 hover:bg-blue-500 transition-colors rounded-full p-2 shadow-md flex items-center justify-center">
              ...
              <a href="https://x.com/foundrr278?t=cXc6vYJm8vQ2T-feY_-YnA&s=09" aria-label="Twitter" className="bg-white/10 hover:bg-blue-400 transition-colors rounded-full p-2 shadow-md flex items-center justify-center">
              ...
              <a href="https://www.instagram.com/foundrr.co?igsh=djlwcWM1NHlqZnFv" aria-label="Instagram" className="bg-white/10 hover:bg-pink-500 transition-colors rounded-full p-2 shadow-md flex items-center justify-center">
